...
Testing & \begin{tabular}[c]{c}Siegel \\ Soyka \end{tabular} & \begin{tabular}[c]{c}2 \\ 1\end{tabular}    \\ \hline 
Final Documentation & \begin{tabular}[c]{c}Siegel \\ Soyka \end{tabular} & \begin{tabular}[c]{c}3\\ 0\end{tabular}    \\ \hline \hline

Total & \begin{tabular}[c]{c}Siegel\\ Soyka\end{tabular} & \begin{tabular}[c]{c}26\\1\end{tabular}   \\ \hline 
